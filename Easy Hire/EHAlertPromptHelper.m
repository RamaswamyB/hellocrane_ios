...
@interface EHAlertPromptHelper ()

@property (nonatomic, copy) EHAlertPromptCompletionBlock completionBlock;
...
- (instancetype)initWithUserPromptIn:(id)instance withTitle:(NSString *)title
              ...
              destructiveButtonTitle:(NSString *)descrutiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles style:(UIAlertControllerStyle)style completionBlock:(EHAlertPromptCompletionBlock)completionBlock;

@end

@implementation EHAlertPromptHelper
              ...
              destructiveButtonTitle:(NSString *)descrutiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles style:(UIAlertControllerStyle)style completionBlock:(EHAlertPromptCompletionBlock)completionBlock
{
    if (self = [super init]) {
        ...
        GET_ASYNC_MAIN_QUEUE({
            ...
            UIViewController *controller = [EHAlertPromptHelper topMostVisibleViewController];
